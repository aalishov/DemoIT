...
namespace Books.Controllers
{
    public class BooksController : Controller
    {
        ...
        // GET: Books
        public async Task<IActionResult> Index(IndexBookViewModel books)
        {
            books = await bookService.GetBooksAsync(books);
                return View(books);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Descruption,Image")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
